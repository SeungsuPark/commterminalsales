                ...
                <v-list-item v-for="(data, n) in values" :key="n">
                    ...
                    <v-list-item-content>
                        ...
                        <v-list-item-subtitle style="font-size:25px; font-weight:700;">
                            ...
                            [ TerminalProductId :  {{data.terminalProductId }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            temp.data._embedded.insurancesubscriptions.map(obj => obj.id=obj._links.self.href.split("/")[obj._links.self.href.split("/").length - 1])
            this.values = temp.data._embedded.insurancesubscriptions;
