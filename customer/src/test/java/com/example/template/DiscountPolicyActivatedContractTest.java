...
import commterminalsales.MessageApplication;
...
@AutoConfigureStubRunner(
    ...
    ids = "commterminalsales:retargetting:+:stubs"
)
public class DiscountPolicyActivatedContractTest {
    ...
    public void testOnMessageReceived() {
        // Set Contract Label
        stubFinder.trigger("DiscountPolicyActivated");
